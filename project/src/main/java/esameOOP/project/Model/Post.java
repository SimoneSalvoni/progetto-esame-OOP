...
public class Post {
	...
	// Le parole chiave sono divise per gestire meglio l'analisi. Alcune parolo sono
	// troncate per poter
	// riconoscere anche parole che contengono la parola chiava (per esempio
	// "govern" vale per "governo"
	// o "governatore"
...
//questo costruttore serve solo per testing
	 ...
	 * @param created_time Oggetto della classe Calendar che contiene la data di
	 *                     creazione del post
	 ...
	 * Metodo getter
	 * 
	 * @return String con il link contenuto nel post. <i>null</i> se non è presente
	 *         nessun link
	 */
	...
	/**
	 * Questo metodo restituisce tutte le parole chiave
	 * 
	...
	/**
	 * Questo metodo ha il compito di categorizzare politicamente il contenuto del
	 * post controllando la presenza delle parole chiave. Sfrutta il metodo
	 * checkKeywords della classe Operations
	 * 
