...
public class StatLenght {
	...
	/**
	 * Questo metodo costruttore valorizza gli attributi sfruttando metodi della
	 * classe Calculate
	 * 
	 * @param vector Vettore con i post di cui calcolare le statistiche
	 * @see Calculate
	 */
	...
	public String toString() {
		return "StatLenght [minChar=" + minChar + ", maxChar=" + maxChar + ", avgChar=" + avgChar + ", stdDev=" + stdDev
				+ "]";
	}
}